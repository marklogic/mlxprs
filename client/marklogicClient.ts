...
export function sendSparql(dbClientContext: ClientContext, sparqlQuery: string, contentType: ml.GraphsResponseFormat): ml.ResultProvider<Record<string, unknown>> {
